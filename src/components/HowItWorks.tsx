...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="relative overflow-hidden py-20 sm:py-28 bg-surface">
        ...
        <Stagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, i) => (
            <StaggerItem key={step.title} className="text-center relative">
              ...
              >
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 text-xl" aria-hidden>{step.emoji}</span>
